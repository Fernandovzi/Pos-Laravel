            ...
            <div class="card-body">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="regimen_fiscal" id="regimen_fiscal" maxlength="3" class="form-control" value="{{old('regimen_fiscal', $cliente->persona->regimen_fiscal)}}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="uso_cfdi" id="uso_cfdi" maxlength="4" class="form-control" value="{{old('uso_cfdi', $cliente->persona->uso_cfdi)}}">
                        @error('uso_cfdi')
                        <small class="text-danger">{{'*'.$message}}</small>
                        @enderror
                    </div>
