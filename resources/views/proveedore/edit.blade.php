...
<div class="container-fluid px-4">
    ...
    <div class="card text-bg-light">
        <form action="{{ route('proveedores.update',['proveedore'=>$proveedore]) }}" method="post">
            ...
            <div class="card-body">
                <p class="text-muted">Tipo: <span class="fw-bold">{{ strtoupper($proveedore->persona->tipo->value)}}</span></p>

                <div class="row g-3">
                    <div class="col-12">
                        <label for="razon_social" class="form-label">
                            {{ $proveedore->persona->tipo->value == 'FISICA' ? 'Nombres y apellidos:' : 'Nombre de la empresa:'}}
                        </label>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="telefono" id="telefono" class="form-control" value="{{old('telefono', $proveedore->persona->telefono)}}">
                        @error('telefono')
                        <small class="text-danger">{{'*'.$message}}</small>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="rfc" id="rfc" maxlength="13" class="form-control" value="{{old('rfc', $proveedore->persona->rfc)}}">
                        @error('rfc')
                        <small class="text-danger">{{'*'.$message}}</small>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="codigo_postal_fiscal" id="codigo_postal_fiscal" maxlength="5" class="form-control" value="{{old('codigo_postal_fiscal', $proveedore->persona->codigo_postal_fiscal)}}">
