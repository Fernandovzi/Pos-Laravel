...
class Kardex extends Model
{
    ...
    public function crearRegistro(array $data, TipoTransaccionEnum $tipo): void
    {
        ...
        if ($tipo == TipoTransaccionEnum::ProduccionInterna || $tipo == TipoTransaccionEnum::CancelacionPedido || $tipo == TipoTransaccionEnum::CancelacionVenta) {
    ...
    private function getDescripcionTransaccion(array $data, TipoTransaccionEnum $tipo): string
    {
        ...
        switch ($tipo) {
            ...
            case TipoTransaccionEnum::CancelacionPedido:
                ...
                break;
            case TipoTransaccionEnum::CancelacionVenta:
                $descripcion = 'Reingreso por cancelación de venta n°' . $data['venta_id'];
                break;
        }
    ...
    public function calcularPrecioVenta(int $producto_id): float
    {
        ...
        $costoUltimoRegistro = (float) ($ultimoRegistro?->costo_unitario ?? 0);
    ...
    public function costoInicializacion(int $producto_id): float
    {
        ...
        return (float) ($ultimoRegistro?->costo_unitario ?? 0);
    }
